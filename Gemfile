...
gem "activerecord", '~> 4.2.7' #gives us all the excellent class methods you see above (and more) and allows for object relational mapping
...
gem "rerun" #allows us to have our server automatically reload when the code changes.